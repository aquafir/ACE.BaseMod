namespace ACE.Shared.Helpers
{
    public static class SpawnExtensions
    {
        ...
        {
            return landblock.sortedCreaturesByNextTick;
        ...
        {
            return landblock.sortedGeneratorsByNextGeneratorUpdate;
        ...
        public static List<GeneratorProfile> GetCreatureProfiles(this Landblock landblock)
        {
            if (!_landblockCreatureGenerators.TryGetValue(landblock, out var profiles))
            {
                ...
                var creatureGenerators = gens.Where(gen => CREATURE_GENERATOR_IDS.Contains(gen.WeenieClassId));
                ...
                var inactive = gens.Where(gen => CREATURE_GENERATOR_IDS.Contains(gen.WeenieClassId));
