...
//            if (spell.Flags.HasFlag(Entity.Enum.SpellFlags.Beneficial) && !spell.Flags.HasFlag(Entity.Enum.SpellFlags.SelfTargeted)
//                //Require researchable for any < 6
//                && (spell.Level > 6 || !spell.Flags.HasFlag(Entity.Enum.SpellFlags.NotResearchable))
