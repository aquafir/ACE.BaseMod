...
public class LevelCost(double C = 100, double Rate = 2, double Coefficient = 2, GrowthType GrowthType = GrowthType.Exponential)
{
    /// <summary>
    /// Get the cost needed to go from x to y
    /// </summary>
    public long GetTotalCost(long x, long n) => GrowthType switch
    {
    ...
    /// </summary>
    public long GetTotalCost(long n) => GrowthType switch
    {
    ...
    /// </summary>
    public long GetCost(long n) => GrowthType switch
    {
        //C(n)=C​+n*r
