...
/// </summary>
public class PropertyInstanceIdAutocompleteHandler : AutocompleteHandler
{
    public override async Task<AutocompletionResult> GenerateSuggestionsAsync(IInteractionContext context, IAutocompleteInteraction autocompleteInteraction, IParameterInfo parameter, IServiceProvider services)
    {
        ...
        IEnumerable<AutocompleteResult> results = Enum.GetNames<PropertyInstanceId>()
...
/// </summary>
public class PlayerPropertyInstanceIdAutocompleteHandler : AutocompleteHandler
{
    public override async Task<AutocompletionResult> GenerateSuggestionsAsync(IInteractionContext context, IAutocompleteInteraction autocompleteInteraction, IParameterInfo parameter, IServiceProvider services)
    {
        //Get the focused value?
        ...
        IEnumerable<AutocompleteResult> results = player.GetAllPropertyInstanceId().Keys
...
/// </summary>
public class SelectedPropertyInstanceIdAutocompleteHandler : AutocompleteHandler
{
    public override async Task<AutocompletionResult> GenerateSuggestionsAsync(IInteractionContext context, IAutocompleteInteraction autocompleteInteraction, IParameterInfo parameter, IServiceProvider services)
    {
        //Get the focused value?
        ...
        //Use target's properties
        IEnumerable<AutocompleteResult> results = target.GetAllPropertyInstanceId().Keys
            .Select(x => x.ToString())
            .Take(25)   //API max of 25
            .Where(x => x.Contains(option.Value?.ToString(), StringComparison.OrdinalIgnoreCase))
            .Select(x => new AutocompleteResult(x, x));
