...
namespace QuestBonus
{
    ...
    public class PatchClass
    {
        ...
        public static void HandleQuestPoints(Session session, params string[] parameters)
        {
            ...
            var qp = player.GetProperty(PatchClass.Settings.QuestBonusProperty) ?? 0;
    ...
    public static class Helpers
    {
        ...
        public static void UpdateQuestPoints(this Player player) => player.SetProperty(PatchClass.Settings.QuestBonusProperty, player.CalculateQuestPoints());
        ...
        {
            var current = player.GetProperty(PatchClass.Settings.QuestBonusProperty) ?? 0;
            
            player.SetProperty(PatchClass.Settings.QuestBonusProperty, current + amount);
        }
        ...
        {
            var qb = player.GetProperty(PatchClass.Settings.QuestBonusProperty) ?? 0;
