...
public static class FakeIronman
{
    ...
    {
        //Check/find container player
        //if (!ObjectGuid.IsPlayer(containerGuid))
        //    return true;
        //var player = PlayerManager.GetOnlinePlayer(containerGuid);

        //If the container is Ironman and the item is not reject it
        //if (player is not null && player.GetProperty(FakeBool.Ironman) == true && item.GetProperty(FakeBool.Ironman) != true)
